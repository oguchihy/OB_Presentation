...
mean_gap <- round(mean(summary_data$annual_incidence_rate, 0))

```

For our patient population, annually, an average  of **```r mean_gap```%*** of pregnancies were not delivered; 21-29 age_group was highest at 17% while the rest were even at 15%. Numbers were derived by adding the gravidarity numbers and substracting parity numbers, while taking into account that G1P0 counts as G1P1; and accounting for multiple gestations.
