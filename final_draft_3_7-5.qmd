...
The intersecting vertical and horizontal lines in the top / Survival Plot determine "median survival (time)": the time at which survival probability is 50% (time at which half the population will have survived (or experienced) the event). Time, for our purposes, is measured in hours since hospital admission registration.
