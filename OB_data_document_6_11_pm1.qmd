...
plot(deliveries_ts, xaxt = "n", main = "Weekly Deliveries", xlab = "Date", ylab = "Deliveries")

# Customize the x-axis
dates <- seq.Date(from = as.Date("2022-01-01"), by = "week", length.out = length(tst$deliveries))
axis(1, at = seq(2022, 2022 + (length(tst$deliveries) - 1) / 52, by = 1 / 52), 
     labels = format(dates, "%Y-%m-%d"), las = 2, cex.axis = 0.7)
