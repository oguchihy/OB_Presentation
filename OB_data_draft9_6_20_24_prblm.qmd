...
# plt_ts <-   plot(deliveries_ts, xaxt = "n", main = "Weekly Deliveries", ylab = "Deliveries", xlab = "", col = "blue", lwd = 2)
# 
...
<!-- # Conditional Shiny initialization -->
...
We use Multinomial regression analysis to discover coefficients
