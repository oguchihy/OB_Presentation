...
fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            selectInput("predictor", "Choose Predictor:", choices = colnames(ob_data_tte)),
...
#         multinom_model <- multinom(conditions_cnsldt ~ hghRsk + weight, data = ob_data_tte)
...
#         fit <- fitModel()
#         ggforest3(fit, data = ob_data_tte)
#     })
#     
