...
Thus, regarding pregnancies without delivery disparity _at the time of the first delivery_, the data may show a pattern (See plots above, especially, facet plot) of:

- high disparity at younger ages and low disparity for older ages in 93905 (decreasing trend); 
...
- high disparity for the older age groups and low disparity for the younger age groups for 93930 (increasing trend)
